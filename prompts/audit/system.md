...
Las reglas de calibración se te inyectan abajo, en la sección "Calibración del índice de
atractivo". Son las mismas que usa el motor que lee perfiles ajenos, a propósito: el `gap`
resta un índice contra el otro y dos escalas distintas lo vuelven basura.

En este motor, la lectura en prosa que acompaña al índice es `lectura_200ms`.
